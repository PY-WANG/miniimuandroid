...
public class DataMonitor extends FragmentActivity implements OnClickListener {
    ...
    public void URLClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.urlJYZK:
                intent.setData(Uri.parse("https://github.com/PY-WANG"));
                break;
            case R.id.urlEM:
                intent.setData(Uri.parse("mailto:18818217569@163.com"));
                break;
        }
    ...
    public void RefreshButtonStatus() {
        if (selected[0]) {
            ((TextView) findViewById(R.id.button0)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.button0)).setTextColor(Color.GRAY);
        }
        if (selected[1]) {
            ((TextView) findViewById(R.id.button1)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.button1)).setTextColor(Color.GRAY);
        }
        if (selected[2]) {
        ...
        if (selected[3]) {
            ((TextView) findViewById(R.id.button3)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.button3)).setTextColor(Color.GRAY);
        }
        if (selected[4]) {
        ...
        if (selected[7]) {
            ((TextView) findViewById(R.id.button7)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.button7)).setTextColor(Color.GRAY);
        }
        if (selected[8]) {
            ((TextView) findViewById(R.id.button8)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.button8)).setTextColor(Color.GRAY);
        }
        if (selected[9]) {
            ((TextView) findViewById(R.id.button9)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.button9)).setTextColor(Color.GRAY);
        }
        if (selected[10]) {
            ((TextView) findViewById(R.id.buttonA)).setTextColor(Color.BLACK);
        } else {
            ((TextView) findViewById(R.id.buttonA)).setTextColor(Color.GRAY);
        }
    }
